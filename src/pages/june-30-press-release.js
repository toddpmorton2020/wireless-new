        ...
        <div className="pt-5 overflow-hidden">
          <div className="container mx-auto">
            <div className="flex items-center text-sm flex-wrap sm:text-black text-white mb-10 sm:mb-20">
              ...
              <span className="mx-2">&gt;</span>
              <span to="#">June 30, 2021 Press Release</span>
            </div>
            ...
            <div className="press-release-padding sm:pt-10 pt-6 sm:text-black text-white">
              ...
              <div className="sm:bg-transparent bg-green-100 sm:mx-0 -mx-6 pt-5 sm:pt-0 sm:text-left text-center sm:mb-0 mb-5">
                <p className="sm:text-23 text-base press-text font-extralight pb-2 sm:px-0 px-5">
                  ...
                  tripod projector stands available online only have enough
                  space to hold the projector and no other cinema equipment.
                  After a year of designing, building, and testing various
                  outdoor projector stands in my woodshop, I came up with my
                  latest design that I now include with all my outdoor cinemas."
                </p>
                <img
                  src="/todd-sign.png"
                  alt=""
                  className="sm:hidden inline-block items-center pb-2"
                />
              </div>
              <p className="sm:text-23 text-base press-text sm:hidden block font-extralight pb-5 mt-6">
                <strong>
                  Features and benefits of the Outdoor Projector Stand
                </strong>
              </p>
              <p className="sm:text-23 text-base press-text hide font-extralight pb-5 mt-12">
                <strong>
                  Features and benefits of the Wireless Outdoor Cinema include:
                </strong>
              </p>
              <p className="sm:text-23 text-base press-text font-extralight pb-5 sm:ml-8 ml-2 indent">
