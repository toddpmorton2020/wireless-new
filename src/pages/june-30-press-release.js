      ...
      <div className="xl:bg-white bg-grey-10 pb-12">
        <div className="container mx-auto">
          <div className="container-insider">
            ...
            <div>
              <h1 className="text-14 xl:pt-10 pt-8 press-release-padding press-line-height hide">
            ...
            <div className="press-release-padding xl:pt-10 pt-6 xl:text-black text-white">
              ...
              <p className="xl:text-23 text-base press-text xl:invisible visible font-extralight pb-5 xl:-mt-6">
                <strong>
                  Features and benefits of the Outdoor Projector Stand
                </strong>
              </p>
              <p className="xl:text-23 text-base press-text hide font-extralight pb-5 xl:-mt-12">
                <strong>
                  Features and benefits of the Wireless Outdoor Cinema include:
                </strong>
              </p>
              <p className="xl:text-23 text-base press-text font-extralight pb-5 xl:ml-8 ml-2 indent">
