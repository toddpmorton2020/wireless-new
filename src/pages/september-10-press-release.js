...
function Sept10PressRelease() {
  return (
    <Layout>
      <SEO
        title="Wireless Outdoor Cinema Company | Partners with Binnie Media"
        description="The Wireless Outdoor Cinema Company today announced the partnership with Binnie Media on running a promotional giveaway for 107.5 Frank FM Fantasy Pro Football Challenge."
      />
          ...
          <div className="container mx-auto">
            ...
            <div className="sm:hidden block text-center">
              ...
              <h1 className="press-release-heading pt-5 text-white font-extrabold pb-3">
                ...
                Fantasy Pro Football Challenge
              </h1>
            </div>
            ...
            <p className="text-grey-100 image-text-press text-sm sm:hidden block pt-10">
              The Fantasy Pro Football Challenge begins September 10, 2020, and
            ...
            <div className="hidden sm:block press-release-padding">
              ...
              The winner of the 107.5 Frank FM Fantasy Pro Football Challenge will receive the 150" Big Moose Wireless Outdoor Cinema package with installation
              </h2>
            ...
            <div className="press-release-padding sm:pt-10 pt-6 sm:text-black text-white">
              ...
              <div className="sm:bg-transparent bg-orange-1000 sm:mx-0 -mx-6 pt-5 sm:pt-0 sm:text-left text-center">
                <p className="sm:text-23 text-base press-text font-extralight pb-2 sm:px-0 px-5">
                  "I'm excited about this opportunity to work with Jon Sundberg,
                  VP Sales, of Binnie Media, and giveaway my 150" Big Moose
                  Outdoor Cinema," said Todd Morton, owner of the Wireless
                  Outdoor Cinema Company." "Maine is full of football fans, and
                  to allow one of these fans to watch the Super Bowl on the 150"
                  Big Moose Outdoor Cinema, would give them an incredible
                  experience."
                </p>
                <img
                  src="/todd-sign.png"
                  alt=""
                  className="sm:hidden block items-center inline-block pb-2"
                />
              </div>
              <div className="sm:bg-transparent bg-blu-200 sm:mx-0 -mx-6 pt-5 sm:pt-0 sm:text-left text-center sm:mb-0 mb-5 mt-8">
                <p className="sm:text-23 text-base press-text font-extralight pb-3 sm:px-0 px-5">
                  "We love partnering with innovative local companies that offer
                  unique products. The Wireless Outdoor Cinema Company checks
                  all those boxes," said Jon Sundberg, VP Sales of Binnie Media.
                  "The contest will have a ton of entries given how attractive
                  this prize is, and our contest winner will be nothing short of
                  ecstatic to not only win it but have The Wireless Outdoor
                  Cinema Company set it up in their backyard."
                </p>
                <img
                  src="/jon-sign.png"
                  alt=""
                  className="sm:hidden inline-block items-center pb-3"
                />
              </div>
              <p className="sm:text-23 text-base press-text font-extralight sm:hidden block pb-3">
