          ...
          <div className="py-5 xl:pt-5">
            ...
            <div className="mt-12 flex flex-col-reverse xl:flex-row">
              <div className="flex-1 mt-6 xl:mt-0 pr-0 xl:pr-12">
                <h1 className="text-purple-500 text-3xl sm:text-5xl leading-none relative">
                  120" Bella Bear
                </h1>
            ...
            <div className="mt-12 flex flex-col xl:flex-row mb-16">
              ...
              <div className="flex-1 pl-0 xl:pl-12 text-center md:text-left rightContainer">
                <h3 className="sm:text-3xl text-xl mb-2 attaching-gaming">Attaching the Screen</h3>
                <p className="mb-4">
            ...
            <div className="mt-12 flex flex-col-reverse xl:flex-row">
              <div className="flex-1 mt-6 xl:mt-0 pr-0 xl:pr-12">
                <h3 className="text-xl sm:text-3xl mb-2">Using the Cinema Equipment</h3>
                <p className="mb-4">
