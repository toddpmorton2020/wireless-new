    ...
    <Layout>
      ...
      <div className="gray-back pb-24">
        <div className="container mx-auto">
          <div className="md:px-8 change sm:py-6">
            ...
            <div className="mt-12">
              <h1 className="text-center sm:text-left sm:text-black sm:text-orange-500 text-3xl sm:text-5xl leading-none sm:font-bold relative heading">
                Privacy{" "}
            ...
            <div className="sm:mt-8">
              ...
              <div className="mt-6">
                ...
                <p className="mb-6">- SSL Protocol</p>
                <p className="mb-6">
                ...
                <p className="mb-6">
                  ...
                  Wireless Outdoor Cinema has not adhered to this Statement,
                  please contact Wireless Outdoor Cinema at:
                </p>
                <p className="mb-6">
                  The Wireless Outdoor Cinema
                  <br />
                  PO Box 752
                  <br />
