      ...
      <div className={showVid && "hidden"}>
        ...
        <DesktopContainer className="">
          ...
          >
            ...
            >
              ...
              <div className=" ">
                ...
                >
                  <div
                    className="absolute bg-black opacity-50 w-9/12 md:w-8/12 lg:w-1/2 xl:w-5/12 h-full"
                    style={{ height: "50%" }}
                  />
                  <div className="container mx-auto header-align-text">
          ...
          <div class="grid grid-section-center-align full-width content-center gap-4">
            <div className="grid-background-first-section"></div>
            <div className="">
              <Gray className=" ">
                <Introduction
                  className="container mx-auto"
          ...
          <div class="grid grid-section-center-align full-width content-center gap-4">
            <div className=""></div>
            <div className="">
              <White className=" " style={{ paddingTop: "10px" }}>
                <Introduction
          ...
          <div className="grid grid-section-center-align full-width content-center gap-4">
            <div></div>
            <div>
              <h2></h2>
              <White className="">
                    ...
                    <div className="content-center txt-center">
                      ...
                      >
                        ...
                        <Link
                          ...
                          to="/timberline-cinema-packages/96-jedi-bobcat-cinema"
                        >
                          <button className="sp-button  mt-5">
                            Learn more
                          </button>
                        </Link>
                      </div>
                    ...
                    <div className="content-center txt-center">
                      ...
                      >
                        ...
                        <p className="text-center text-purple-1000 text-lg h3-grid-large-p-txt">
                          ...
                          >
                            {" "}
                            Learn more about the 120” Bella Bear Backyard
                            Outdoor Cinema.
                          </Link>
                        </p>
                        <hr className="bg-#E0E0E0  hr-grid mt-8 mb-2"></hr>
                    ...
                    <div className="content-center txt-center">
                      ...
                      >
                        ...
                        <Link
                          ...
                          to="/timberline-cinema-packages/150-big-moose-cinema"
                        >
                          <button className="sp-button  mt-4">
                            Learn more
                          </button>
                        </Link>
                      </div>
          ...
          <div class="grid grid-section-center-align full-width content-center gap-4">
            <div className="grid-background-first-section"></div>
            <div className="grid-background-first-section">
              {" "}
              <h2></h2>
              <Gray className=" ">
                <Introduction className="container mx-auto">
