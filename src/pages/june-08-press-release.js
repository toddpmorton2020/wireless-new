        ...
        <div className="container mx-auto">
          <div className="container-insider">
            ...
            <div className="press-release-padding xl:pt-10 pt-6 xl:text-black text-white">
              ...
              <div className="xl:bg-transparent bg-orange-1000 xl:mx-0 -mx-6 pt-5 xl:pt-0 xl:text-left text-center xl:mb-0 mb-5">
                <p className="xl:text-23 text-base press-text font-extralight pb-2 xl:px-0 px-5">
                  ...
                  my property, I knew immediately other homeowners would love
                  this outdoor experience as much as I do,” said Todd Morton,
                  owner of the Wireless Outdoor Cinema Company. “The cinema
                  setup looks impressive on your property with its 4” x 4“
                  pressure-treated framing system for the screen, and comes with
                  an easy setup to start watching your favorite movie, show, or
                  use your Xbox, PlayStation, or Wii to game under the stars and
                  moon.”
                </p>
                <img
                  src="/todd-sign.png"
              ...
              <p className="xl:text-23 text-base press-text font-extralight pb-5 xl:-mt-8">
                <strong>
